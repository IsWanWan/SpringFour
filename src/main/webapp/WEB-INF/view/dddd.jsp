...
<div id="main">
    ...
    <p><b><font color="#DF0101">请下载文档，下载链接：</font></b>&nbsp;&nbsp;<a target="_blank" class="links" href="/CentOS Nginx Tomcat7 JDK镜像使用手册V1.6.pdf">《CentOS Nginx Tomcat7 JDK镜像使用手册V1.6.pdf》</a></p>
